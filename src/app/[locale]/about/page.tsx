  ...
  return (
    <main className="px-5 py-6">
      <div className="max-w-[320px] mx-auto md:max-w-[768px] xl:max-w-[1228px] relative">
        <h1 className="font-lora text-[40px] font-normal leading-[51.2px] text-center uppercase mb-[34px] md:text-[64px] md:leading-[81.92px] md:mb-[48px]">
          {t('title')}
        </h1>
        <div className="flex flex-col gap-4 md:flex-row md:justify-between md:gap-[29px] xl:gap-[46px]">
          <Image
        ...
        <div className="mt-[-50px] flex justify-end md:absolute md:bottom-40 md:left-40 xl:bottom-0 xl:right-0">
          <Image
